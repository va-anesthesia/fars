...
FARS is based on [JSON](https://en.wikipedia.org/wiki/JSON), the data model used by all (over 16 billion) internet connected systems and devices, and also used by the international health record exchange standard [FHIR](https://en.wikipedia.org/wiki/Fast_Healthcare_Interoperability_Resources)
